  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Něco se pokazilo na naší straně. Zkuste obnovit stránku nebo se vraťte domů.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Profesionální daňové poradenství pro firmy i jednotlivce. Daňová přiznání, účetnictví, audit a strategické poradenství." },
      { name: "author", content: "Marek Valenta" },
      ...
      { name: "twitter:site", content: "@marekvalenta" },
    ],
    links: [
      {
        rel: "stylesheet",
